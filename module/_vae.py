...
from distributions import NegativeBinomial, Poisson, ZeroInflatedNegativeBinomial
from module.base import BaseModuleClass, LossRecorder, auto_move_data
from nn import DecoderSCVI, Encoder, LinearDecoderSCVI, one_hot
...
class VAE(BaseModuleClass):
    ...
    def __init__(
        ...
        print("encode_covariates: {}, encoder_cat_list:{}".format(encode_covariates, encoder_cat_list))

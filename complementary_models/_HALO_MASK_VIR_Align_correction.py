...
from data import organize_multiome_anndatas
...
from model._utils import _init_library_size
from model.base import UnsupervisedTrainingMixin
from utils import setup_anndata_dsp
from model.base import ArchesMixin, RNASeqMixin, VAEMixin, BaseModelClass
import torch
...
import pandas as pd
from helpers._types import Number
...
from utils._docstrings import doc_differential_expression, setup_anndata_dsp
from scipy.sparse import csr_matrix, vstack
from helpers._utils import _doc_params

from functools import partial
from model.base._utils import _de_core
...
class HALOMASKVIR(RNASeqMixin, VAEMixin, ArchesMixin, UnsupervisedTrainingMixin, BaseModelClass):
    def __init__(
        ...
        **model_kwargs,
        ...
        self._model_summary_string = (
            "HALO Model with the following params: \nn_hidden: {}, n_latent: {}, n_layers: {}, dropout_rate: "
    ...
    def get_atac_expr_denoms(
        ...
        give_mean
            Give mean of distribution or sample from it.
        batch_size
            Minibatch size for data loading into model. Defaults to `halo.settings.batch_size`.
        Returns
        -------
        latent_representation : np.ndarray
            Low-dimensional representation for each cell
    ...
    def plot_compare_topic_enrichments(self, topic_1, topic_2, factor_type = 'motifs', 
        ...
        color = 'grey', label_closeness = 3, max_label_repeats = 3, show_factor_ids = False, size=20):
        '''
        ...
        return plot_factor_influence(m1, m2, ax = ax, label_factors = label_factors,
            ...
            fontsize = fontsize, color = color, size=size)    
    ...
    def setup_dataset(multiomic="halo/E18_mouse_Brain/multiomic.h5ad", rna_ann="halo/E18_mouse_Brain/RNA/metadata.tsv"):
        ...
        adata_mvi = organize_multiome_anndatas(adata_multi)

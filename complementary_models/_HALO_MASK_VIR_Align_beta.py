...
import numpy as np
from ._HALO_MASK_VAE_Align_beta import  HALOMASKVAE_beta as HALOMASKVAE
...
class HALOMASKVIR_beta(RNASeqMixin, VAEMixin, ArchesMixin, UnsupervisedTrainingMixin, BaseModelClass):
    def __init__(
        self,
        adata: AnnData,
        n_genes :int,

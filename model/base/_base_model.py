...
from helpers._types import AnnOrMuData
from data import AnnDataManager
from data._compat import registry_from_setup_dict
...
from data._utils import _assign_adata_uuid, _check_if_view
from dataloaders import AnnDataLoader
from model._utils import parse_use_gpu_arg
from model.base._utils import _load_legacy_saved_files
from utils import attrdict, setup_anndata_dsp
...
class BaseModelClass(metaclass=BaseModelMetaClass):
    ...
    def load2(
        ...
        print("init_params: ", attr_dict["init_params_"]["non_kwargs"])
        attr_dict["init_params_"]["non_kwargs"].update(additional)
        print(attr_dict["init_params_"]["non_kwargs"])
        model = _initialize_model(cls, adata, attr_dict)
        model.module.on_load(model)
        model.module.load_state_dict(model_state_dict)
